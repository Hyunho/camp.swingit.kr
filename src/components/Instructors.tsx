...
const instructorPeople: InstructorPerson[] = [
  {
    name: 'Peter Loggins',
    role: 'Instructor',
    imageUrl: '/images/2026/DANCERS/Peter_Loggins.jpg',
          ...
          {person.imageUrls.map((imageUrl, imageIndex) => (
            ...
            >
              <Image
                ...
                sizes={
                  singleColumn
                    ? '(min-width: 1024px) 48rem, 95vw'
                    : '(min-width: 1024px) 10rem, (min-width: 640px) 12rem, 45vw'
                }
                className={singleColumn ? 'object-contain bg-zinc-50 p-2' : 'object-cover'}
              />
            </div>
          ))}
        </div>
        ...
        >
          <Image
            ...
            sizes={
              singleColumn
                ? '(min-width: 1024px) 48rem, 95vw'
                : '(min-width: 1024px) 22rem, (min-width: 640px) 28rem, 95vw'
            }
            className={singleColumn ? 'object-contain bg-zinc-50 p-2' : 'object-cover'}
          />
        </div>
